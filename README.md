...
godoc: https://godoc.org/github.com/bookreport/graphql

### Getting Started

To install the library, run:
```bash
go get github.com/bookreport/graphql
```
...
```
For more complex examples, refer to the [examples/](https://github.com/bookreport/graphql/tree/master/examples/) directory and [graphql_test.go](https://github.com/bookreport/graphql/blob/master/graphql_test.go).

### Third Party Libraries
| Name          | Author        | Description  |
|:-------------:|:-------------:|:------------:|
| [graphql-go-handler](https://github.com/bookreport/graphql-go-handler) | [Hafiz Ismail](https://github.com/sogko) | Middleware to handle GraphQL queries through HTTP requests. |
| [graphql-relay-go](https://github.com/bookreport/graphql-relay-go) | [Hafiz Ismail](https://github.com/sogko) | Lib to construct a graphql-go server supporting react-relay. |
